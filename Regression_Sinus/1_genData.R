...
X = (0:(n-1))/(n-1) #train input points
y = f(X) + rnorm(mean=0,sd=sdn,n=n)  #observation training data

pdf("data.pdf")  #plotting the function and observations
plot(Xt,f(Xt),type="l",ylim=c(0,1.5),xlab="x",ylab="f",
...
save(f,X,Xt,y,phi,Mn,Mt,Xm,file="data.Rdata")
